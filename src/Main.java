				...
				if (day.equalsIgnoreCase("Понеділок")) {
					...
					if (group == 1)
						if (week == 1) {
							...
							// if(group == 1 && week == 1) {System.out.println("3. Алгоритмізація та
							// програмування, 8-213, Фратавчан В.Г.");}
						}
					if (group == 2)
						if (week == 2) {
							System.out.println("3. Алгоритмізація та програмування, 8-213, Фратавчан В.Г.");
							// if(group == 2 && week == 2) {System.out.println("3. Алгоритмізація та
							// програмування, 8-213, Фратавчан В.Г.");}
						}
					System.out.println("4. Фізичне виховання (за вибором)");
				} else if (day.equalsIgnoreCase("Вівторок")) {
					...
					// if(group == 1 && week == 1){System.out.println("4. Комп'ютерна графіка,
					// 8-213, Фратавчан В.Г.");}
					if (group == 2)
						if (week == 1) {
							System.out.println("4. Дискретна математика, 8-212, Стецько Ю.П.");
						}
					// if(group == 2 && week == 1) {System.out.println("4. Дискретна математика,
					// 8-212, Стецько Ю.П.");}
					if (group == 1)
						if (week == 2) {
							System.out.println("4. Дискретна математика, 8-212, Філіпчук О.І.");
						}
					// if(group == 1 && week == 2) {System.out.println("4. Дискретна математика,
					// 8-212, Філіпчук О.І.");}
					if (group == 2)
						if (week == 2) {
							System.out.println("4. Комп'ютерна графіка, 8-213, Фратавчан В.Г.");
						}
					// if(group == 2 && week == 2) {System.out.println("4. Комп'ютерна графіка,
					// 8-213, Фратавчан В.Г.");}
				} else if (day.equalsIgnoreCase("Середа")) {
					...
					// if(group == 2 && week == 1) {System.out.println("4. Комп'ютерна графіка,
					// 8-213, Фратавчан В.Г.");}
					if (group == 1)
						if (week == 2) {
							System.out.println("4. Комп'ютерна графіка, 8-213, Фратавчан В.Г.");
						}
					// if(group == 1 && week == 2) {System.out.println("4. Комп'ютерна графіка,
					// 8-213, Фратавчан В.Г.");}
				} else if (day.equalsIgnoreCase("Четвер")) {
					System.out.println("1. Іноземна мова, 8-202, Черепня Ю.В.");
					if (group == 1)
						if (week == 1) {
							System.out.println("2. Теорія алгоритмів, 8-213, Сопронюк Є.Ф.");
						}
					// if(group == 1 && week == 1) {System.out.println("2. Теорія алгоритмів, 8-213,
					// Сопронюк Є.Ф.");}
					if (group == 2)
						if (week == 1) {
							System.out.println("2. Веб-технології та веб-дизайн, 8-216, Кириченко О.Л.");
						}
					// if(group == 2 && week == 1) {System.out.println("2. Веб-технології та
					// веб-дизайн, 8-216, Кириченко О.Л.");}
					if (group == 1)
						if (week == 2) {
							System.out.println("2. Веб-технології та веб-дизайн, 8-216, Кириченко О.Л.");
						}
					// if(group == 1 && week == 2) {System.out.println("2. Веб-технології та
					// веб-дизайн, 8-216, Кириченко О.Л.");}
					if (group == 2)
						if (week == 2) {
							System.out.println("2. Теорія алгоритмів, 8-213, Сопронюк Є.Ф.");
					...
					// if(group == 1 && week == 1) {System.out.println("3. Веб-технології та
					// веб-дизайн, 8-216, Кириченко О.Л.");}
					if (group == 2)
						if (week == 2) {
							System.out.println("3. Веб-технології та веб-дизайн, 8-216, Кириченко О.Л.");
						}
					// if(group == 2 && week == 2) {System.out.println("3. Веб-технології та
					// веб-дизайн, 8-216, Кириченко О.Л.");}
					System.out.println("4. Іноземна мова (СПЕЦГРУПА), 8-202, Венкель О.В.");
				} else if (day.equalsIgnoreCase("П'ятниця") || day.equalsIgnoreCase("Пятниця")) {
